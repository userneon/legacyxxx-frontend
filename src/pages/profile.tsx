  ...
  return (
    <section className="glass rounded-xl p-5">
      <div className="mb-4 flex items-center gap-3">
        <div className="flex size-9 items-center justify-center rounded-lg bg-orange-500/10"><img src="/manus-storage/faceit-orange-mark-transparent_5fb02996.png" alt="FACEIT" className="size-6 object-contain" /></div>
